...
SamplingData::SamplingData(unsigned long long random_seed, int batch_size, int vocab_size, cudaStream_t stream) {
  ...
  CUDA_CHECK(cub::DeviceSegmentedRadixSort::SortPairsDescending(nullptr, temp_storage_bytes_full_sort, (float*)nullptr, (float*)nullptr, (int*)nullptr, (int*)nullptr, vocab_batch_size, batch_size, (int*)nullptr, (int*)nullptr, 0, sizeof(float) * 8, stream));
  // Case 2: Temp storage for map-reduce bitonic sort's worst case.
  size_t temp_storage_bytes_bitonic_sort = 0;
  CUDA_CHECK(cub::DeviceSegmentedRadixSort::SortPairsDescending(nullptr, temp_storage_bytes_bitonic_sort, (float*)nullptr, (float*)nullptr, (int*)nullptr, (int*)nullptr, intermediate_buffer_elements, batch_size, (int*)nullptr, (int*)nullptr, 0, sizeof(float) * 8, stream));
