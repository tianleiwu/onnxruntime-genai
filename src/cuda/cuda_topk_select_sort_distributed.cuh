...
namespace cuda {
namespace distributed_selection_sort {
...
__global__ void DistributedTopKKernel(
  ...
  if (shard_idx == 0) {
    ...
    switch (sort_size) {
      case 2:
        bitonic_sort::SharedMemBitonicSort_SoA<kBlockSize, 2>(smem_scores, smem_indices);
        break;
      case 4:
        bitonic_sort::SharedMemBitonicSort_SoA<kBlockSize, 4>(smem_scores, smem_indices);
        break;
      case 8:
        bitonic_sort::SharedMemBitonicSort_SoA<kBlockSize, 8>(smem_scores, smem_indices);
        break;
      case 16:
        bitonic_sort::SharedMemBitonicSort_SoA<kBlockSize, 16>(smem_scores, smem_indices);
        break;
      case 32:
        bitonic_sort::SharedMemBitonicSort_SoA<kBlockSize, 32>(smem_scores, smem_indices);
        break;
      case 64:
        bitonic_sort::SharedMemBitonicSort_SoA<kBlockSize, 64>(smem_scores, smem_indices);
        break;
      case 128:
        bitonic_sort::SharedMemBitonicSort_SoA<kBlockSize, 128>(smem_scores, smem_indices);
        break;
      case 256:
        bitonic_sort::SharedMemBitonicSort_SoA<kBlockSize, 256>(smem_scores, smem_indices);
        break;
      case 512:
        bitonic_sort::SharedMemBitonicSort_SoA<kBlockSize, 512>(smem_scores, smem_indices);
        break;
      case 1024:
        bitonic_sort::SharedMemBitonicSort_SoA<kBlockSize, 1024>(smem_scores, smem_indices);
        break;
      case 2048:
        bitonic_sort::SharedMemBitonicSort_SoA<kBlockSize, 2048>(smem_scores, smem_indices);
        break;
      default:
        if (sort_size > 1) { /* This case should ideally not be hit with the logic above */
        }
        break;
    }
    __syncthreads();
