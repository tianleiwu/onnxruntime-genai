...
namespace cuda {
namespace bitonic_v8 { // Sort within registers in block reduce
static const char* kAlgoDescription = "Bitonic v8 (Sort within registers in block reduce)";

// --- START: Device Helper Function ---
